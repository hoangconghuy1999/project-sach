...
const SUCCESS_DELETE_FAKE = {
    statusCode: 200,
    message: 'Dlete account Mock success'
}
const CHECK_VERSION = {
    statusCode: 200,
    message: "Can not delete"
}
const SUCCESSFULLY_ADDED_FEEDBACK = {
    statusCode: 200,
    message: "Cuccessfully added feedback"
}
const   CHECK_INPUT = {
    statusCode: 200,
    message: "Check input"
}
const CREATR_FEEDBACK_FAILED = {
    statusCode: 400,
    message: "Create feedback failed"
}

module.exports = {
    CREATR_FEEDBACK_FAILED,
    CHECK_INPUT,
    TRANSACTION_SUCCESS,
    CHANGE_STATUS_DONE,
    TRANSACTION_FAILED,
